import { mysqlTable, mysqlSchema, AnyMySqlColumn, primaryKey, int, varchar, timestamp, date, index, mysqlEnum } from "drizzle-orm/mysql-core"
...
export const users = mysqlTable("users", {
	...
	role: mysqlEnum("role", ['buyer','member','club admin','school admin','super admin']),
